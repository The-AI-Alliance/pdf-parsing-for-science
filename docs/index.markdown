...
# Parsing PDFs for Advancing the Use of AI in Science
...
Welcome to the **The AI Alliance**: **Parsing PDFs for Advancing the Use of AI in Science**. 

Please join us! See our [contributing]({{site.baseurl}}/contributing) page for details.

> **TODO:** This is a work-in-progress website for the Parsing PDFs for Advancing the Use of AI in Science.
...
* [Project GitHub Repo](https://github.com/The-AI-Alliance/pdf-parsing-for-science){:target="repo"}
